    ...
    return (
        <div className='max-w-7xl mx-auto p-5'>
            <div className='text-center'>
                ...
                <p className='text-[16px] md:text-[18px] lg:text-[20px] text-[#424242] mt-3 md:mt-4 font-[400] px-4 max-w-full mx-auto'>Online platform to invest in stocks, derivatives, mutual funds, ETFs, bonds, and more.</p>
